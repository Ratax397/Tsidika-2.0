  ...
  return (
    <div className="flex flex-row items-center justify-between">
        ...
        <div className='flex flex-row items-center gap-4'>
            ...
            <div onClick={onAd} className='w-10 h-10 rounded-full border border-neutral-400 flex items-center justify-center text-neutral-600 cursor-pointer hover:opacity-80 transition'>
               <AiOutlinePlus /> 
            </div>
        </div>
    </div>
